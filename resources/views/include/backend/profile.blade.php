...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Widgets | Kadso - Responsive Admin Dashboard Template</title>
                                    ...
                                    <div class="card-body">
                                        <div class="align-items-center">
                                            <div class="d-flex align-items-center">
                                                <img src="{{asset('backend/assets/images/users/user-11.jpg')}}" class="rounded-2 avatar-xxl" alt="image profile">
